    ...
    return (
        <div className="min-h-screen bg-[#FFFBF7] text-zinc-900 font-sans selection:bg-orange-200">
            ...
            <main className="relative z-10 pt-32 pb-24 px-4 max-w-3xl mx-auto space-y-12">
                ...
                {/* --- CONTENT --- */}
                <article className="prose prose-zinc prose-lg max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-a:text-orange-600 prose-a:no-underline hover:prose-a:underline">
                    ...
                    <p>
                        Our App is not intended for children under the age of 13. We do not knowingly collect personal information from children under 13. If we learn we have collected or received personal information from a child under 13 without verification of parental consent, we will delete that information.
                    </p>
                    ...
                    <p>
                        <strong>Email:</strong> support@usechomp.com<br />
                        <strong>Website:</strong> <Link href="/support">usechomp.com/support</Link>
                    </p>
